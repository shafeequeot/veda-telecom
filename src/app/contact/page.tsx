        ...
        <div className="container-px mx-auto">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="space-y-6">
              <div className="card p-6">
                ...
                <ul className="mt-3 space-y-2 text-sm">
                  <li>Office No 333, 4WA, Dubai Airport Freezone (DAFZA), Dubai, UAE</li>
                  <li><a href="mailto:finance@veda-telecom.com" className="text-blue-900">finance@veda-telecom.com</a></li>
                  <li><a href="tel:+97143536660" className="text-blue-900">+971 4 353 6660</a></li>
                </ul>
              </div>
              <div className="card p-6">
                <h3 className="font-semibold text-blue-900 dark:text-slate-100">FAQs</h3>
                <div className="mt-3 space-y-3 text-sm">
                  <details className="rounded-lg border border-slate-200 p-3 dark:border-slate-700">
                    <summary className="cursor-pointer font-medium">Which brands do you supply?</summary>
                    <p className="mt-2 muted">We offer a wide portfolio including Apple, Samsung, Logitech, DJI, and more.</p>
                  </details>
                  <details className="rounded-lg border border-slate-200 p-3 dark:border-slate-700">
                    <summary className="cursor-pointer font-medium">Do you ship internationally?</summary>
                    <p className="mt-2 muted">Yes, we support shipping to multiple regions with optimized routing.</p>
                  </details>
                  <details className="rounded-lg border border-slate-200 p-3 dark:border-slate-700">
                    <summary className="cursor-pointer font-medium">How fast is fulfillment?</summary>
            ...
            <div className="grid gap-6 lg:grid-cols-1">
              <div className="card p-6">
                <h3 className="font-semibold text-blue-900">Send a Message</h3>
                <p className="muted mb-4">Fill out the form and our team will contact you shortly.</p>
                <ContactForm />
              </div>
